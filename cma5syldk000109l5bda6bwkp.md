...
Note:  
It works perfectly well while hosting it locally, but while deploying it, YFinance api has rate limits(typically 2000 requests/per hour/per IP, but its unofficial) and cloud apps like Streamlit sharing public IP’s hit that easily, hence we have used a fall back csv file, it has dataset of Reliance.

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1746198901965/b53774e4-ae35-4d9f-a15d-b7e7f1331e96.jpeg align="center")
